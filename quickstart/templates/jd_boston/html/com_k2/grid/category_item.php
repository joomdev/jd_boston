...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	  ...
	  <h3 class="catItemTitle">
	  	...
	  	<?php if ($this->item->params->get('catItemTitleLinked')): ?>
			<a href="<?php echo $this->item->link; ?>" title="<?php echo $this->item->title;?>">
	  		<?php //echo $str = substr($this->item->title, 0,30);if(strlen($str)<= 30){echo '';}else{echo '...';}
  ...
  $this->item->params->get('catItemAttachments')
		...
		<span class="catItemAuthor">
			...
			<a rel="author" href="<?php echo $this->item->author->link; ?>"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;<?php echo $this->item->author->name; ?></a>
			<?php else: ?>
  ...
  <div class="catItemLinks">
		<div class="bottom-info">
			...
			<span class="catItemDateCreated">
				<i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;<?php echo JHTML::_('date', $this->item->created , JText::_('F d, Y')); ?>
			</span>
			...
			<div class="catItemCategory">
				...
				<a href="<?php echo $this->item->category->link; ?>"><i class="fa fa-folder-o" aria-hidden="true"></i>&nbsp;<?php echo $this->item->category->name; ?></a>
			</div>
			<?php endif; ?>
		</div>
