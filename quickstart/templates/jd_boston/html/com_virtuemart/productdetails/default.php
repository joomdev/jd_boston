...
<?php
	...
	<div id="tabContainer">
            <ul>
            <li>
			<a class="active" href="#tab1"><span class="title"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></span></a></li>
            <li><a href="#tab2"><?php echo vmText::_ ('COM_VIRTUEMART_REVIEWS'); if ($this->rating_reviews) { echo ' ('. count($this->rating_reviews).')';}?></a>
