...
$select_no_oftestimonials = $params->get('select_no_oftestimonials');
...
<style type="text/css">
	...
	.testimonial-<?php echo $module->id; ?> .jd-testimonial-review{
				...
				<div class="jd-testimonial-author-name author-info">
					...
					<?php if(!empty($item->author_companyName)) { ?>
						<div class="jd-testimonial-companyname author-text">
							<?php if(!empty($item->author_companyLink)) { ?><a href="<?php echo $item->author_companyLink; ?>" target="_blank"  rel="nofollow" ><?php } ?><?php echo $item->author_companyName; ?><?php if(!empty($item->author_companyLink)) { ?></a><?php } ?>
						</div>
					<?php } ?>
...
<script>
	(function ($) {
		...
		$('.testimonial-<?php echo $module->id; ?>').slick({
			...
			slidesToShow: <?php echo $select_no_oftestimonials; ?>,
			slidesToScroll: <?php echo $select_no_oftestimonials; ?>, 
