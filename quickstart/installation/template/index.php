...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	...
	<body data-basepath="<?php echo JUri::root(true); ?>">
		...
		<div class="container">
         ...
         .btn-primary, .step.active span { background: #02aed6;border-color: transparent; }
			.btn-primary:hover ,.btn-primary:focus { background: #02aed6;}
         .nav-tabs>.active>a, .nav-tabs>.active>a:hover, .nav-tabs>.active>a:focus {color: #02aed6;}
