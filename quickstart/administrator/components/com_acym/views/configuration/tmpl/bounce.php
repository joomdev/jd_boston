	...
	<div class="acym_area padding-vertical-1 padding-horizontal-2">
		...
		<div class="grid-x">
			<label class="cell grid-x">
				...
				<input class="cell medium-4" type="email" name="config[bounce_email]" placeholder="<?php echo acym_translation('ACYM_BOUNCE_EMAIL_PLACEHOLDER'); ?>" value="<?php echo acym_escape($data['config']->get('bounce_email')); ?>" />
			</label>
			<label class="cell grid-x">
				<span class="cell medium-3"><?php echo acym_translation('ACYM_SMTP_SERVER'); ?></span>
				<input class="cell medium-4" type="text" name="config[bounce_server]" value="<?php echo acym_escape($data['config']->get('bounce_server')); ?>">
			</label>
			<label class="cell grid-x">
				<span class="cell medium-3"><?php echo acym_translation('ACYM_SMTP_PORT'); ?></span>
				<input class="cell medium-2" type="text" name="config[bounce_port]" value="<?php echo acym_escape($data['config']->get('bounce_port')); ?>">
			</label>
			<label class="cell grid-x">
			...
			<div class="cell grid-x">
                <?php echo acym_switch('config[bounce_certif]', $data['config']->get('bounce_certif', 1), acym_translation('ACYM_SELF_SIGNED_CERTIFICATE'), [], 'medium-3'); ?>
			</div>
			<label class="cell grid-x">
				<span class="cell medium-3"><?php echo acym_translation('ACYM_SMTP_USERNAME'); ?></span>
				<input class="cell medium-4" type="text" name="config[bounce_username]" value="<?php echo acym_escape($data['config']->get('bounce_username')); ?>">
			</label>
			<label class="cell grid-x">
			...
			<label class="cell grid-x">
				...
				<input class="cell medium-2" type="text" name="config[bounce_timeout]" value="<?php echo acym_escape($data['config']->get('bounce_timeout', 10)); ?>">
			</label>
			<label class="cell grid-x">
				<span class="cell medium-3"><?php echo acym_translation('ACYM_MAX_NUMBER_EMAILS'); ?></span>
				<input class="cell medium-2" type="text" name="config[bounce_max]" value="<?php echo acym_escape($data['config']->get('bounce_max', 100)); ?>">
			</label>
			<div class="cell grid-x">
                <?php echo acym_switch('config[auto_bounce]', $data['config']->get('auto_bounce'), acym_translation('ACYM_ENABLE_AUTO_BOUNCE'), [], 'medium-3'); ?>
			</div>
			<div class="cell grid-x grid-margin-x" id="acym__configuration__bounce__auto_bounce__configuration" <?php echo $data['config']->get('auto_bounce') ? '' : "style='display: none'"; ?>>
				<div class="cell grid-x">
					...
					<span class="cell medium-9"><?php echo acym_date($data['config']->get('auto_bounce_last'), 'Y-m-d H:i'); ?></span>
					<span class="cell medium-3"><?php echo acym_translation('ACYM_NEXT_RUN_TIME'); ?></span>
					<span class="cell medium-9"><?php echo acym_date($data['config']->get('auto_bounce_next'), 'Y-m-d H:i'); ?></span>
					<span class="cell medium-3"><?php echo acym_translation('ACYM_REPORT'); ?></span>
					<span class="cell medium-9"><?php echo $data['config']->get('auto_bounce_report'); ?></span>
				</div>
			</div>
		</div>
	</div>
