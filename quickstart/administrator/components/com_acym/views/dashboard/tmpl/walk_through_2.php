...
<input type="hidden" name="mailer_method" value="<?php echo acym_escape($data['mailer_method']); ?>" id="acym__walk-through-2__way-mail">
		...
		<div class="cell grid-x acym__content cell text-center">
			...
			<div class="cell grid-x acym__walk-through-2__choose_external-server" <?php echo $data['use_server'] ? 'style="display:none"' : ''; ?>>
				...
				<div class="cell grid-x acym__walk-through-2__smtp-server" <?php echo (!$data['use_server'] && $data['mailer_method'] == 'smtp') || $data['use_server'] ? '' : 'style="display:none"'; ?>>
					...
					<input <?php echo empty($data['smtp_host']) ? '' : 'value="'.acym_escape($data['smtp_host']).'"'; ?> type="text" class="input-group-field cell" name="smtp[server]" id="acym__walk-through-2__smtp_server" placeholder="<?php echo acym_translation('ACYM_SERVER_ADDRESS'); ?>">
					...
					<input <?php echo empty($data['smtp_port']) ? '' : 'value="'.acym_escape($data['smtp_port']).'"'; ?> type="text" class="input-group-field cell" name="smtp[port]" id="acym__walk-through-2__smtp_port" placeholder="<?php echo acym_translation('ACYM_SMTP_PORT'); ?>">
					...
					<input <?php echo empty($data['smtp_username']) ? '' : 'value="'.acym_escape($data['smtp_username']).'"'; ?> type="text" class="input-group-field cell" name="smtp[username]" id="acym__walk-through-2__smtp_username" placeholder="<?php echo acym_translation('ACYM_SMTP_USERNAME'); ?>">
				...
				<div class="cell grid-x acym__walk-through-2__elastic-email" <?php echo !$data['use_server'] && $data['mailer_method'] == 'smtp' ? 'style="display:none"' : ''; ?> <?php echo $data['use_server'] ? 'style="display:none"' : ''; ?>>
					...
					<input <?php echo empty($data['elasticemail_username']) ? '' : 'value="'.acym_escape($data['elasticemail_username']).'"'; ?> type="text" class="input-group-field cell" name="elastic[username]" id="acym__walk-through-2__elastic_username" placeholder="<?php echo acym_translation('ACYM_SMTP_USERNAME'); ?>">
					...
					<input <?php echo empty($data['elasticemail_password']) ? '' : 'value="'.acym_escape($data['elasticemail_password']).'"'; ?> type="text" class="input-group-field cell" name="elastic[password]" id="acym__walk-through-2__elastic_password" placeholder="<?php echo acym_translation('ACYM_SMTP_PASSWORD'); ?>">
