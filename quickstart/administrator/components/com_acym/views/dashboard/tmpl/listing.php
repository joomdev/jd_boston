            ...
            <?php } else { ?>
                ...
                foreach ($data['campaignsScheduled'] as $campaign) {
					...
					<div class="cell grid-x acym__dashboard__active-campaings__one-campaing">
						...
						<p id="<?php echo intval($campaign->id); ?>" class="medium-6 small-12 acym__dashboard__active-campaings__one-campaing__action acym__color__dark-gray"><?php echo acym_translation('ACYM_CANCEL_SCHEDULING'); ?></p>
					</div>
