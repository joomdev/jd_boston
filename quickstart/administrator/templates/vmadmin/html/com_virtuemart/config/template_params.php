...
<div class="well nr-well ">
     <h4><?php echo vmText::_('COM_VIRTUEMART_ADMIN_CFG_SHOPFRONT_SETTINGS'); ?></h4>
     <div class="well-desc"></div>


		<?php
		echo VmHTML_override::row('genericlist','COM_VIRTUEMART_ADMIN_CFG_SHOW_STORE_DESC',$options, 'show_store_desc', '', 'value', 'text', $params->get('show_store_desc',1));
		echo VmHTML_override::row('genericlist','COM_VIRTUEMART_ADMIN_CFG_SHOW_CATEGORYDESC',$options, 'showcategory_desc', '', 'value', 'text', $params->get('showcategory_desc',1));
		echo VmHTML_override::row('genericlist','COM_VIRTUEMART_ADMIN_CFG_SHOW_SEARCH',$options, 'showsearch', '', 'value', 'text', $params->get('showsearch',1));


		echo '<table class="admintable smallinputs ">';
		echo '<tr><th style="min-width:160px;width:250px"></th>
<th style="min-width:40px;;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_SHOW_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_SHOW').'</span></th>
<th style="min-width:40px;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_PER_ROW_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_PER_ROW').'</span></th>
<th style="min-width:40px;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_OMIT_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_OMIT').'</span></th>
</tr>';
		...
		echo '<table class="admintable smallinputs" style="margin-top:10px !important;">';
		echo '<tr><th style="min-width:160px;width:250px;"></th>
<th style="min-width:40px;;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_SHOW_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_SHOW').'</span></th>
<th style="min-width:40px;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_ROWS_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_ROWS').'</span></th>
<th style="min-width:40px;text-align: center;"><span class="hasTip" title="'.htmlentities(vmText::_('COM_VM_ADMIN_CFG_OMIT_TIP')).'">'.vmText::_('COM_VM_ADMIN_CFG_OMIT').'</span></th>
</tr>';
