...
if ($enable_footer) {
   ...
   $html = '<div id="astroid-footer" class="astroid-footer">' . $footertext . ' Powered by <a href="https://astroidframework.com" target="_blank">Astroid</a>. Design by <a href="https://joomdev.com" target="_blank">JoomDev</a></div>';
   echo $html;
}
?> 