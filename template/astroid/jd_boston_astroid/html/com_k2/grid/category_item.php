  ...
  <div class="catItemLinks">
		<div class="bottom-info">
			...
			<span class="catItemDateCreated">
				<i class="far fa-clock" aria-hidden="true"></i>&nbsp;<?php echo JHTML::_('date', $this->item->created , JText::_('F d, Y')); ?>
			</span>
			...
			<div class="catItemCategory">
				...
				<a href="<?php echo $this->item->category->link; ?>"><i class="far fa-folder" aria-hidden="true"></i>&nbsp;<?php echo $this->item->category->name; ?></a>
			</div>
			<?php endif; ?>
		</div>
