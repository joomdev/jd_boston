...
<div id="k2Container" class="itemView default<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
		...
		<div class="itemImageBlock">
			<span class="itemImage">
				<a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
					<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:1200px; height:auto;" />
				</a>
			</span>
...
<div class="top-status-bar">
	...
	<?php if($this->item->params->get('itemCategory')): ?>
		...
		<div class="itemCategory">
			<span><i class="fa fa-folder-o" aria-hidden="true"></i><?php //echo JText::_('K2_PUBLISHED_IN'); ?></span>
	...
	<div class="itemToolbar">
		<ul>
			...
			<li>
				...
				<?php else: ?>
				<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><?php echo JText::_('Comments'); ?></a>
				<?php endif; ?>
				<?php endif; ?>
			</li>
			<?php endif; ?>
...
<div class="buttom-tools">	
	...
	<div class="itemLinks">
		...
		<div class="itemTagsBlock">
			<span><?php echo JText::_('Tag'); ?></span>
			<ul class="itemTags">
	...
	*/
	...
	<div class="itemComments">
		...
		<h3 class="itemCommentsCounter">
			<?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?><span> ( <?php echo $this->item->numOfComments; ?> )</span>
		</h3>
		...
		<ul class="itemCommentsList">
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
				...
				<img src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width=70; />
				<?php endif; ?>
				...
				<span class="commentDate"><?php echo JHTML::_('date', $comment->commentDate, JText::_('F d, Y')); ?></span>
