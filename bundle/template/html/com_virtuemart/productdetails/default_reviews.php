			...
			foreach ($this->rating_reviews as $review) {
				...
				if (!empty($this->rating_reviews) && $review->published) {
					...
					<div class="<?php echo $color ?>">
						<div class="review-meta"><span class="bold"><?php echo $review->customer ?></span>
						<span class="date"><?php echo JHtml::date ($review->created_on, vmText::_ ('F j ,Y')); ?></span>
						<span class="vote"><?php echo $stars[(int)$review->review_rating] ?></span></div>
						<div class="review-text">
						<blockquote><?php echo $review->comment; ?></blockquote></div>
